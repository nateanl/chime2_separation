...
model = Sequential()
# the 1st LSTM layer
#model.add(BatchNormalization(batch_input_shape = (None,None,513),epsilon=1e-05, mode=0, axis=2, momentum=0.99, weights=None, beta_init='zero', gamma_init='one', gamma_regularizer=None, beta_regularizer=None))
